...
public class AstronautaEdit extends javax.swing.JFrame {

	private Astronauta novoAstronauta;
	private AstronautaDAO dao;
	@SuppressWarnings("unused")
	private JRadioButton falecidoRadioButton;
	 ...
	 */
	public AstronautaEdit() throws HeadlessException, SQLException {
		//Connection con = chamaSQL();
		//dao = new AstronautaDAO(con);
		//setPaises(dao.pegaPaises(con));
		setTitle("Viajantes Espaciais - Atualiza̤̣o de Cadastro de Astronauta");
		try{
			setIconImage(ImageIO.read(new File("./imagens/vetor/astronaut-icon.png")));
		}
		catch (IOException e){
			e.printStackTrace();
		}
	...
	private void initComponents() {
		...
		lBio_eng.setText("Bio Ingl̻s");
		lMissao1.setText("Misṣo 1");
		lMissao2.setText("Misṣo 2");
		lMissao3.setText("Misṣo 3");
		lMissao4.setText("Misṣo 4");
		lMissao5.setText("Misṣo 5");
		lMissao6.setText("Misṣo 6");
		lMissao7.setText("Misṣo 7");
		lMissao8.setText("Misṣo 8");
		lFoto.setText("Foto");
		lSexo.setText("Sexo");
		...
		bSalvar.addActionListener(new java.awt.event.ActionListener() {
			...
			private void bSalvarActionPerformed(ActionEvent evt) throws ParseException, NullPointerException, HeadlessException, SQLException {
				...
				java.util.List<String> missao = new ArrayList<>();
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(() -> {
			try {
				new AstronautaEdit().setVisible(true);
